...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('videos_video', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=200))

    def backwards(self, orm):

        # Changing field 'Video.slug'
        db.alter_column('videos_video', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
