...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videos_videotype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('videos', ['VideoType'])

        # Adding field 'Video.video_type'
        db.add_column('videos_video', 'video_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.VideoType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VideoType'
        db.delete_table('videos_videotype')
    ...
    models = {
        ...
        'videos.video': {
            ...
            'update_dt': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'video_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.VideoType']", 'null': 'True', 'blank': 'True'}),
